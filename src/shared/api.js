...
api.interceptors.request.use(
  async request => {
    // const accessToken =
    //   (await store?.getState()?.authReducer?.accessToken) ||
    //   api.defaults.headers.common[constants.ACCESS_TOKEN_KEY];
    // request.headers[constants.ACCESS_TOKEN_KEY] = accessToken;
    if (__DEV__) {
      let logObj = {};
      ...
      console.log(
        ...
        // constants.ACCESS_TOKEN_KEY + ':' + accessToken,
